...
class HomeBannerCategoryScreen extends StatelessWidget {
  HomeBannerCategoryScreen({Key? key}) : super(key: key);
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 15),
                      mediumText("Pizza Party", ColorResources.REDB70, 22),
                      SizedBox(height: 7),
                      bookText(
                          "Enjoy pizza from Johnny and \n get upto 30% off",
                          ColorResources.grey8E8,
                          14),
                      SizedBox(height: 16),
                      mediumText("Starting from", ColorResources.grey8E8, 12),
                      SizedBox(height: 4),
                      boldText("₹299", ColorResources.REDB70, 17),
                      SizedBox(height: 7),
                      Container(
                        height: 24,
                        width: 160,
                        ...
                        child: Row(
                          ...
                          children: [
                            lightText(
                                "Use Coupon:", ColorResources.grey8E8, 12),
                            boldText("WELCOME50", ColorResources.REDB70, 12),
                          ],
                        ),
                      ),
                    ],
